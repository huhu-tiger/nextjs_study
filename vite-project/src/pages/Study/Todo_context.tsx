...
const TodoContext = createContext<Iprops | null>(null);


const Task: React.FC = () => {
    const {List, dispatch} = useContextSelector(TodoContext, (state) => ({
...
const TodoContextComponent: React.FC = () => {
    ...
    return (
        <VStack>
            ...
            <Box>
                <TodoContext.Provider value={{List: state.List, dispatch: dispatch}}>
                    <Task ></Task>
